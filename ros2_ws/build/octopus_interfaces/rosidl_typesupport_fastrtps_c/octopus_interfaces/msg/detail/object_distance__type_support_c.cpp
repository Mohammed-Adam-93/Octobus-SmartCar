...
#include "octopus_interfaces/msg/detail/object_distance__rosidl_typesupport_fastrtps_c.h"
...
using _ObjectDistance__ros_msg_type = octopus_interfaces__msg__ObjectDistance;
...
size_t get_serialized_size_octopus_interfaces__msg__ObjectDistance(
  const void * untyped_ros_message,
...
static uint32_t _ObjectDistance__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_octopus_interfaces__msg__ObjectDistance(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_octopus_interfaces
size_t max_serialized_size_octopus_interfaces__msg__ObjectDistance(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = octopus_interfaces__msg__ObjectDistance;
    is_plain =
      (
...
static size_t _ObjectDistance__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_octopus_interfaces__msg__ObjectDistance(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, octopus_interfaces, msg, ObjectDistance)() {
